...
/**
 * We implement different versions of RPNI/EDSM that also consider implication/inductive examples
 * @param <P>
 * @param <S>
 */
public class LearningWithIndEx<P,S> {
    ...
    /**
     * Algorithm that calls EDSM as a subroutine and computes a fixed point
     */
    public static <P, S> SFA<P, S> EDSMInductiveFixedPoint(LearningSamples<S> samples, BooleanAlgebra<P, S> algebra)
            throws DeterminismViolationException, TimeoutException {
